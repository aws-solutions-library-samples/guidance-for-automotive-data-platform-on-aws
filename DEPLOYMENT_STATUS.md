...
- **Domain ID**: DATAZONE_DOMAIN_ID_3
- **Portal URL**: https://DATAZONE_DOMAIN_ID_3.sagemaker.us-east-1.on.aws
...
### IAM Identity Center
- **Instance**: IDENTITY_STORE_ID (ssoins-7223ca64466274fc)
- **SSO User Created**: user@example.com (UserId: 84f89498-a021-70bb-c323-d2c72128cd37)
...
1. **Access Portal**: https://DATAZONE_DOMAIN_ID_3.sagemaker.us-east-1.on.aws
...
├── DataZone Domain (DATAZONE_DOMAIN_ID_3)
