...
1. **Open DataZone Console**
   ```
   https://us-east-1.console.aws.amazon.com/datazone/home?region=us-east-1#/domains/DATAZONE_DOMAIN_ID/blueprints
   ```
...
2. **Enable Required Blueprints**
   ...
   ### MLExperiments
   - ManageAccessRole: `arn:aws:iam::195026230833:role/datazone-DATAZONE_DOMAIN_ID-manage-access`
   - ProvisioningRole: `arn:aws:iam::195026230833:role/datazone-DATAZONE_DOMAIN_ID-provisioning`
...
2. **Deploy CloudFormation**
   ...
   aws cloudformation create-stack \
       ...
       --parameters \
           ParameterKey=DomainId,ParameterValue=DATAZONE_DOMAIN_ID \
           ParameterKey=ManageAccessRoleArn,ParameterValue=arn:aws:iam::195026230833:role/datazone-DATAZONE_DOMAIN_ID-manage-access \
           ParameterKey=ProvisioningRoleArn,ParameterValue=arn:aws:iam::195026230833:role/datazone-DATAZONE_DOMAIN_ID-provisioning \
